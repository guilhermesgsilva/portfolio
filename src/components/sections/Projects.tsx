export const Projects = () => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-gray-400 mb-4">
              Scalable cloud infrasctucture management with real-time monitoring
  ...
  hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.2)] transition transition-all"
          >
            ...
            <p className="text-gray-400 mb-4">
              Intelligent data visualization platform with predictive insights,
              anomaly detection, and interactive reports powered by machine
              learning.
            </p>
            <div className="flex flex-wrap gap-2" mb-4>
  ...
  hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.2)] transition transition-all"
          >
            ...
            <div className="flex flex-wrap gap-2" mb-4>
              {["Next.js", "Node.js", "Stripe", "MongoDB"].map((tech, key) => {
                return (
                  <span
                    key={key}
                    className="bg-blue-500/10 text-blue-500 py-1 px-3 rounded-full text-sm hover:bg-blue-500/20
